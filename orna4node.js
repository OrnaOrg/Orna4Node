...
fs.appendFileSync(cssname, '@media ' + device + ' and (max-width:' + querywidth +'){ .' + val[0] + '_' + val[1] + '_' + val[2] + '{padding:' + dblval + ';} }\n');                        } else if (val[0] == "pl") {
                        ...
                        if (val[0] == "bg") {
                            ...
                            fs.appendFileSync(cssname, '.' + val[0] + '_' + val[1] + '_' + val[2] + ' ' + id + '{background-image:' + dblval + ';}\n');
                        } else if (val[0] == "bgc") {
                            fs.appendFileSync(cssname, '.' + val[0] + '_' + val[1] + '_' + val[2] + ' ' + id + '{background-color:' + dblval + ';}\n');
                        } else if (val[0] == "w") {
                            fs.appendFileSync(cssname, '.' + val[0] + '_' + val[1] + '_' + val[2] + ' ' + id + '{width:' + dblval + ';}\n');
                        } else if (val[0] == "h") {
                            fs.appendFileSync(cssname, '.' + val[0] + '_' + val[1] + '_' + val[2] + ' ' + id + '{height:' + dblval + ';}\n');
                        } else if (val[0] == "p") {
                            fs.appendFileSync(cssname, '.' + val[0] + '_' + val[1] + '_' + val[2] + ' ' + id + '{padding:' + dblval + ';}\n');
                        } else if (val[0] == "pl") {
                            fs.appendFileSync(cssname, '.' + val[0] + '_' + val[1] + '_' + val[2] + ' ' + id + '{padding-left:' + dblval + ';}\n');
                        } else if (val[0] == "pr") {
                            fs.appendFileSync(cssname, '.' + val[0] + '_' + val[1] + '_' + val[2] + ' ' + id + '{padding-right:' + dblval + ';}\n');
                        } else if (val[0] == "pt") {
                            fs.appendFileSync(cssname, '.' + val[0] + '_' + val[1] + '_' + val[2] + ' ' + id + '{padding-top:' + dblval + ';}\n');
                        } else if (val[0] == "pb") {
                            fs.appendFileSync(cssname, '.' + val[0] + '_' + val[1] + '_' + val[2] + ' ' + id + '{padding-bottom:' + dblval + ';}\n');
                        } else if (val[0] == "m") {
                            fs.appendFileSync(cssname, '.' + val[0] + '_' + val[1] + '_' + val[2] + ' ' + id + '{margin:' + dblval + ';}\n');
                        } else if (val[0] == "ml") {
                            fs.appendFileSync(cssname, '.' + val[0] + '_' + val[1] + '_' + val[2] + ' ' + id + '{margin-left:' + dblval + ';}\n');
                        } else if (val[0] == "mr") {
                            fs.appendFileSync(cssname, '.' + val[0] + '_' + val[1] + '_' + val[2] + ' ' + id + '{margin-right:' + dblval + ';}\n');
                        } else if (val[0] == "mt") {
                            fs.appendFileSync(cssname, '.' + val[0] + '_' + val[1] + '_' + val[2] + ' ' + id + '{margin-top:' + dblval + ';}\n');
                        } else if (val[0] == "mb") {
                            fs.appendFileSync(cssname, '.' + val[0] + '_' + val[1] + '_' + val[2] + ' ' + id + '{margin-bottom:' + dblval + ';}\n');
                        } else if (val[0] == "b") {
                            fs.appendFileSync(cssname, '.' + val[0] + '_' + val[1] + '_' + val[2] + ' ' + id + '{border:' + dblval + ';}\n');
                        } else if (val[0] == "bl") {
                            fs.appendFileSync(cssname, '.' + val[0] + '_' + val[1] + '_' + val[2] + ' ' + id + '{border-left:' + dblval + ';}\n');
                        } else if (val[0] == "br") {
                            fs.appendFileSync(cssname, '.' + val[0] + '_' + val[1] + '_' + val[2] + ' ' + id + '{border-right:' + dblval + ';}\n');
                        } else if (val[0] == "bt") {
                            fs.appendFileSync(cssname, '.' + val[0] + '_' + val[1] + '_' + val[2] + ' ' + id + '{border-top:' + dblval + ';}\n');
                        } else if (val[0] == "bb") {
                            fs.appendFileSync(cssname, '.' + val[0] + '_' + val[1] + '_' + val[2] + ' ' + id + '{border-bottom:' + dblval + ';}\n');
                        } else if (val[0] == "c") {
